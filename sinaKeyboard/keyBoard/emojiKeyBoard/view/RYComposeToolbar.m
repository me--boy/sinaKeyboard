...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 添加所有的子控件
        [self addButtonWithIcon:@"compose_camerabutton_background" highIcon:@"compose_camerabutton_background_highlighted" tag:RYComposeToolbarButtonTypeCamera];
        [self addButtonWithIcon:@"compose_toolbar_picture" highIcon:@"compose_toolbar_picture_highlighted" tag:RYComposeToolbarButtonTypePicture];
//        [self addButtonWithIcon:@"video" highIcon:@"video" tag:RYComposeToolbarButtonTypeVideo];
        [self addButtonWithIcon:@"compose_mentionbutton_background" highIcon:@"compose_mentionbutton_background_highlighted" tag:RYComposeToolbarButtonTypeMention];
//RYComposeToolbarButtonTypeMention
        ...
        self.emotionButton = [self addButtonWithIcon:@"compose_emoticonbutton_background" highIcon:@"compose_emoticonbutton_background_highlighted" tag:RYComposeToolbarButtonTypeEmotion];
    }
    return self;
}
